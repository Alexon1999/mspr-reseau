...
function showAlerts(data) {
  ...
  const content = `
    <div class="alert__container">
      ...
      <p class="recommandation">Nous vous recommandon d'utiliser <span style="font-weight:bold;"> Google Authenticator</span> <img src="https://play-lh.googleusercontent.com/HPc5gptPzRw3wFhJE1ZCnTqlvEvuVFBAsV9etfouOhdRbkp-zNtYTzKUmUVPERSZ_lAL=s360-rw" width="60px"/>
      </p>
